...
| `docs/copy.md` | 对外话术参考（品牌物料，非开发文档） | 现为占位初稿，人工审核定稿后随话术演进同步 |
...
- **品牌物料双语，英文为主**：README、官网、软件 UI 以英文为第一语言、中文（zh-Hans）为第二语言；`docs/copy.md` 是了解项目话术的参考（定位、命名、概念词对照），非派生源头，各载体独立成稿、保持话术一致。
- **开发文档随开发者语言，用中文**：docs/、plans/、代码注释、提交信息主题——它们是开发者写给自己看的。`docs/copy.md` 虽在 docs/ 下，属品牌参考，双语。
